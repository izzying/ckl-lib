...
public class QueryHelper {
	...
	protected Query delegateParameterUpdateForQuery(
			ParameterType parameterType, Query query, Object... parameters) {
	...
	/**
	 * Creates a new {@link Query} object.<br />
	 * The {@link Query} object could be a native query ({@link QueryType} =
	 * {@link QueryType#NATIVE}) or a JPQL query ({@link QueryType} ==
	 * {@link QueryType#JPQL})
	 * 
	 * @param _sql
	 * @param queryType
	...
	/**
	 * Creates a new {@link Query} object. Each parameter is injected by name.<br />
	...
	/**
	 * Creates a JPQL query. Each parameter is injected by index.<br />
	...
	protected Query updateParametersByName(Query q, Object... parameters) {
		if (parameters.length % 2 == 1) {
			log.error("Could not update parameters by name for query [" + q
